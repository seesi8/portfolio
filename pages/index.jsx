...
export async function getServerSideProps({ }) {
  ...
  let projects = []
  const projectsRef = query(collection(firestore, "projects"), orderBy("datemade", "desc"), limit(4))
  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.moreButtonContainer}>
        <button onClick={goToPosts} className={styles.moreButton}><h1 className={styles.moreButtonTitle}>More</h1></button>
      </div>
      <Contact />
